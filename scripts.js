function factorycalc(reverse) {
  ...
  const wood_log = new MatDef("Wood Log", [0, 15], 0, [1], 0);
  const copper = new MatDef("Copper", [0, 15], 0, [1], 1);
  const iron = new MatDef("Iron", [0, 15], 0, [1], 2);
  const stone = new MatDef("Stone", [0, 15], 0, [1], 3);
  const wolfram = new MatDef("Wolframite", [0, 15], 0, [1], 4);
  const coal = new MatDef("Coal", [0, 15], 0, [1], 5);
  ...
  // non-extractor factories (Workshop, Furnace, etc.)
  var boostFactory = [1, 1.5, 2, 3, 4];

  // extractor (factory id 0) levels: 1x, 2x, 4x, 8x, 10x
  var boostExtractor = [1, 2, 4, 8, 10];
  ...
  // Assign new rates in relation to the "tier" or "Level" assigned to each factory
  for (i = 0; i < materialdata.length; i++) {
    var factoryId = materialdata[i].factory[0];
    var levelIndex = levelFactory[factoryId]; // 0–4 from <select> values

    if (factoryId === 0) {
      // Extractors (Wood, Copper, Iron, Stone, Wolframite, Coal)
      materialdata[i].factory[1] =
        materialdata[i].factory[1] * boostExtractor[levelIndex];
    } else {
      // All other factories use the old boost curve
      materialdata[i].factory[1] =
        materialdata[i].factory[1] * boostFactory[levelIndex];
    }
  }
  ...
  if (reverse == true) {
    ...
    for (var i = 1; i < extractor_ratio.length; i++) {
      if (extractor_ratio[i] < extractor_ratio[j]) {
        j = i
      }
...
function reversefactorycalc() {
  ...
  for (var i = 1; i++; i < length(extractor_ratio)) {
    if (extractor_ratio[i] < extractor_ratio[i - 1]) {
      j = i
    }
  }
...
function factoryname(id) {
  ...
  if (id == 7) {
    return "Earth Teleporter"
  };
  if (id == 8) {
    return "Uranium Extractor"
  };
  if (id == 9) {
...
function createTierButton() {
  ...
  for (i = 0; i < size; i++) {
    tempStr = allChild[i].id;
    if ((tempStr.substring(5, 6)) > rank) {
      rank = allChild[i].id.substring(5, 6)
    };
  }
  if (i > 1) {
    for (i = 1; i <= rank; i++) {
      ...
      tempDiv.id = "rank" + i;
      if (i == 1) {
        tempDiv.setAttribute("class", "buttonStart")
      } else {
        if (i == rank) {
          tempDiv.setAttribute("class", "buttonEnd")
        } else {
          tempDiv.setAttribute("class", "buttonMid")
        }
      }
      tempDiv.innerHTML = i;
...
function findIcon(id) {
  ...
  if (id == 0) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Wood_Log.png"
  };
  if (id == 1) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Copper_ore.png"
  };
  if (id == 2) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Iron_Ore.png"
  };
  if (id == 3) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Stone.png"
  };
  if (id == 4) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Wolframite.png"
  };
  if (id == 5) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Coal.png"
  };
  if (id == 6) {
    return "https://github.com/saprolord/saprolord.github.io/blob/main/image/Wood_Plank.png?raw=true"
  };
  if (id == 7) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Wooden_Frame.png"
  };
  if (id == 8) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Copper_Ingot.png"
  };
  if (id == 9) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Copper_Wire.png"
  };
  if (id == 10) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Iron_Ingot.png"
  };
  if (id == 11) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Iron_Gear.png"
  };
  if (id == 12) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Sand.png"
  };
  if (id == 13) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Silicon.png"
  };
  if (id == 14) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Glass.png"
  };
  if (id == 15) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Tungsten_Ore.png"
  };
  if (id == 16) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Graphite.png"
  };
  if (id == 17) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Tungsten_Carbide.png"
  };
  if (id == 18) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Coupler.png"
  };
  if (id == 19) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Condenser_Lens.png"
  };
  if (id == 20) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Heat_Sink.png"
  };
  if (id == 21) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Iron_Plate.png"
  };
  if (id == 22) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Electromagnet.png"
  };
  if (id == 23) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Metal_Frame.png"
  };
  if (id == 24) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Steel.png"
  };
  if (id == 25) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Steel_Rod.png"
  };
  if (id == 26) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Rotor.png"
  };
  if (id == 27) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Concrete.png"
  };
  if (id == 28) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Battery.png"
  };
  if (id == 29) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Electric_Motor.png"
  };
  if (id == 30) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Logic_Circuit.png"
  };
  if (id == 31) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Carbon_Fibre.png"
  };
  if (id == 32) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Nanowire.png"
  };
  if (id == 33) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Computer.png"
  };
  if (id == 34) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Industrial_Frame.png"
  };
  if (id == 35) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Gyroscope.png"
  };
  if (id == 36) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Stabiliser.png"
  };
  if (id == 37) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Mag_Field_Gen.png"
  };
  if (id == 38) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Quantum_Entangler.png"
  };
  if (id == 39) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Electron_Microscope.png"
  };
  if (id == 40) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/TurboCharger.png"
  };
  if (id == 41) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/SuperComputer.png"
  };
  if (id == 42) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Atomic_Locator.png"
  };
  if (id == 43) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Energy_Cube.png"
  };
  if (id == 44) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Tank.png"
  };
  if (id == 45) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Matter_Compressor.png"
  };
  if (id == 46) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Particle_Glue.png"
  };
  if (id == 47) {
    return "https://raw.githubusercontent.com/saprolord/saprolord.github.io/main/image/Matter_Duplicator.png"
  };
  if (id == 48) {
    return "https://raw.githubusercontent.com/saprolord/Builderment/main/image/Earth_Token.png"
  };
  if (id == 49) {
    return "https://raw.githubusercontent.com/saprolord/Builderment/main/image/Uranium.png"
  };
  if (id == 50) {
    return "https://raw.githubusercontent.com/saprolord/Builderment/main/image/Enriched_Uranium.png"
  };
  if (id == 51) {
    return "https://raw.githubusercontent.com/saprolord/Builderment/main/image/Empty_Fuel_Cell.png"
  };
  if (id == 52) {
    return "https://raw.githubusercontent.com/saprolord/Builderment/main/image/Nuclear_Fuel_Cell.png"
  };
}
